...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGhlb3dsZiIsImEiOiJja2o4ZndmbmI2dGN4MnVxamdyeXcxbjdzIn0.Vfw736qTIOLiQaoMVA9sQQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/theowlf/ckj8nt4l963ec19l94bsnksss',
    scrollZoom: false
  });
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extends map bounds to include curret location
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " was sucessfullu updated"));
            }
...
var stripe = Stripe('pk_test_51I4605Jqvf01daB91HgQkb7oESMwZKIYJUqlAccVbCWreJHzBH8WeraCdapVQIhHTz3jIMfdoawgWuhJReDBa50P005WHxFvTM');
